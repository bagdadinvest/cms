...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0005_remove_customhomepage_service_description_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heading', models.CharField(help_text='Heading for the About Us section.', max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='PatientJourneySnippet',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Name of the patient.', max_length=255)),
                ('journey_title', models.CharField(help_text='Title of the patient journey.', max_length=255)),
                ('journey_subtitle', models.CharField(help_text='Subtitle of the patient journey.', max_length=255)),
                ...
                ('read_more_text', models.CharField(help_text="Text for the 'Read More' button.", max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.CharField(help_text='Price for the pricing item.', max_length=255)),
                ('title', models.CharField(help_text='Title of the pricing item.', max_length=255)),
        ...
        migrations.RemoveField(
            model_name='customhomepage',
            name='more_about_us_background_image',
        ),
        migrations.RemoveField(
            model_name='customhomepage',
            name='patient_journey_subtitle',
        ),
        migrations.RemoveField(
            model_name='customhomepage',
            name='patient_journey_title',
        ),
        migrations.RemoveField(
            model_name='customhomepage',
            name='patient_name',
